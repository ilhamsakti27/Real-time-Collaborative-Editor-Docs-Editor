    ...
    >
      <button>
        ...
        <div class="flex gap-x-2 items-center">
          <div class="inline">
            <span
              :class="['border rounded-md pad', isHighlight && selectedIndex !== null ? colorFonts[selectedIndex].name !== 'Default' ? `bg-[${colorFonts[selectedIndex].setColor}]/20` : '' : '']"
    ...
    <template>
      ...
      >
        ...
        <div class="pb-3 border-b">
          ...
          >
            <span
              :class="['border rounded-md pad', isHighlight && selectedIndex !== null ?
                colorFonts[selectedIndex].name !== 'Default' ? `bg-[${colorFonts[selectedIndex].setColor}]/20` : '' : '']"
              v-html="selectedIndex === null ? defaultIcon : colorFonts[selectedIndex].mainIcon"
            />
        ...
        <div class="pb-3 pt-2 ">
          <div class="text-black/40 text-xs font-semibold px-3 py-2">
            Highlight Color
          </div>
          <button
            v-for="( item, index ) in colorFonts"
